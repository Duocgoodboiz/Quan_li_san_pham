<?php 
     ...
     if(isset($_POST['smb'])){
        ...
        $sql="INSERT INTO products (prd_name ,image ,price ,quanlity,description,brand_id)
        VALUES('$prd_name' ,'$image' ,'$price' ,'$quanlity','$description','$brand_id')";
        ...
        <div class="card-body">
            <form method="post" enctype="multipart/form-data" >
                ...
                <div class="form-group">
                  ...
                  <input type="number" name="quanlity" class="form-control" required>
                </div>
                <div class="form-group">
                ...
                <button name="smb" class="btn btn-success" type="submit">Them</button>
            </form>
        </div>
    </div>
